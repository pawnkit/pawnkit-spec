...
Release-set v2 artifacts may contain:
...
A release set may omit these fields while v2 remains experimental. A set must
...
The fields are optional in the experimental v2 schema. Version 1 is unchanged.
...
Release generators may add evidence to v2 candidates as tool releases become
...
`pawnkit-spec/examples/pawn-release-set-v2` covers the schema. The
